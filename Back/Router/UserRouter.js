...
const {EditeProfile,getProfile,ChangePassword } =require('../Controllers/User/Profile')
...
router.put('/ChangePassword',jwtMiddleware(process.env.secretKey),ChangePassword )
