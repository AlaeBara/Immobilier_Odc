  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response && error.response.data.status === 'failure') {
        ...
        setMessage("Internal Server Error FR");
      }
    }
  };
